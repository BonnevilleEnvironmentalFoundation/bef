<?php
/*
Template Name: Page - Partner Profiles - Consulting Partner Categories
*/
?>
<?php get_header(); ?>
...
<?php wp_nav_menu( array ('menu' => 'Consulting Watershed Categories', 'container' => 'nav','menu_class' => 'tab-nav','depth' => 0,'walker' => new description_walker())) ; ?>

	<h2>consulting partners - <?php echo $page_slug; ?></h2>
