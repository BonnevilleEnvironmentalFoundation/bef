<?php
/*
Template Name: Page - Project Portfolio - Water Consulting Washington
*/
?>
...
<div class="four columns subnav">
	...
	<div class="eight columns">
		...
		<?php endif;?>
		<?php wp_reset_query(); ?>
		<?php wp_nav_menu( array ('menu' => 'Consulting Project Profiles', 'container' => '','menu_class' => 'tab-nav','depth' => 0) ); ?>
<?php $posts = new WP_Query(array( 
   'post_type' => 'bgmp',
   'orderby' => 'meta_value_num',
	 'meta_key' => 'bgmp_zIndex',
   'order' => 'DESC',
	 'bgmp-category' => 'washington',
   'posts_per_page' => 99
)); ?>
