...
<div class="meta-nav">
	<div class="container">
		<ul>
			...
			<li class="leed"><a onclick="window.open(this.href);return false;"  href="http://store.b-e-f.org/calculate-business-footprint/leed/">earn LEED<sup>&reg;</sup> points</a></li>
...
<?php wp_nav_menu( array ('menu' => 'Header-Nav', 'container' => 'nav','menu_class' => 'header-nav','depth' => 0) ); ?><a class="logo" href="<?php bloginfo('url');?>/"><img src="<?php bloginfo('template_directory');?>/images/logo.png" width="70" height="70" alt=""></a>
